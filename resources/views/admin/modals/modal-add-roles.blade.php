<div class="ui add modal small">
    <div class="header">Tambah Role Baru</div>
    <div class="content">
    <form id="add_role_form" action="{{ url('admin/role/store') }}" class="ui form" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
        <div class="field">
        ...
        <div class="field">
            <label>Status</label>
            <select name="status" class="ui dropdown uppercase">
