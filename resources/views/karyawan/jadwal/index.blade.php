@extends('karyawan.layouts.app')
    ...
    $('#filterform').submit(function(event) {
        ...
        $.ajax({
            url: '{{url('karyawan/jadwal/get')}}',type: 'get',dataType: 'json',data: {date_from: date_from, date_to: date_to},headers: { 'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content') },
