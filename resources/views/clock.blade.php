@extends('layouts.clock')
        ...
        <div class="fixedcenter">
            <div class="clockwrapper">
                <div class="clockinout">
                    <button class="btnclock timein active" data-type="timein">Masuk</button>
                    <button class="btnclock timeout" data-type="timeout">Pulang</button>
                </div>
            </div>
                ...
                <div class="userinput">
                    ...
                    <form action="" method="get" accept-charset="utf-8" class="ui form">
                        ...
                        <div class="inline field">
                            <input class="enter_idno uppercase" name="id_no" value="" type="text" placeholder="ENTER YOUR ID" required="">
    ...
    $('#btnclockin').click(function(event) {
        ...
        $.ajax({
       url: url + '/clock/store',type: 'post',dataType: 'json',data: {id_no: idno, type: type, clock_comment: comment},headers: { 'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content') },

            success: function(response) {
                if(response['error'] != null) {
                    function prefix() {
                        var gender = response['gender'];
                        var civilstatus = response['civil_status'];
